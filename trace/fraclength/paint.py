...
up=[0.1,0.11,0.12,0.3,0.2,0.1]

down=[0.1,0.11,0.12,0.3,0.2,0.1]
...
if __name__=='__main__':
	...
	while j < 18:
		...
		improYosemite.append(fair[j][2]/yo[j][2]+0.05*j)
		improveBarrat.append(fair[j][2]/fifolm[j][2])
		improveDark.append(fair[j][2]/fifolm[j][2]*1.1)
		j+=3

	print yoshort
	xticklabel=('1','2','3','4','5','6','7','8','9','0.65','0.7','0.75','0.8','0.85','0.9')
	xlabel='Coflow length(GB)'
	#print fifolm
	...
	ax.legend((rects1[0],rects2[0],rects3[0],rects4[0]), ('Barrat','Aalo','Varys','Yosemite'),loc=2,fontsize=25)
	ax.set_ylabel('Factor of improvement',fontsize=25,fontweight='bold')
	ax.set_xlabel(xlabel,fontsize=25,fontweight='bold')
	ax.set_ylim([0,5])
	fig.savefig("fraclength.eps",dpi=1000)
