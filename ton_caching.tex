...
To overcome the defects of flow level optimization. The recently proposed network abstraction coflow regard job flow set as a whole . Jobs from one or more frameworks create multiple coflows in a shared cluster. The coflow schedule methods regard the flow sets as an entirety. Flows belonging same set sharing same priority.  This method is attractive as even the fifo based method can improve
